      ...
      >
        <div class="lg:py-6">
          <div class="text-center lg:text-left">
            <h1
              class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-4xl"
            >
              Hi, I'm
              <span
                class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500"
              >
                Jayakrishnan PS </span
              >😁
            </h1>
          </div>
          <p
          ...
          >
            Result-driven Software Developer with a strong aptitude for coding,
        ...
        <div class="lg:h-full md:flex">
          ...
          >
            ...
            ></div>
            <div
              class="absolute z-10 top-1/2 -translate-y-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary flex justify-center items-center"
